    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-2">
        ...
        <SettingRow
          ...
          description="Alert when Claude Code or Codex running in a terminal needs your input or finishes. Desktop notification when NovaTerm is unfocused, in-app otherwise."
        >
          <Switch
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-2">
          <SettingRow
            ...
            description="Open NovaTerm automatically when you sign in."
          >
            <Switch
              checked={autostart}
