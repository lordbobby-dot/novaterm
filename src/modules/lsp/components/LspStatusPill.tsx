...
const PILL_CLASS =
  "novaterm-pill-in flex h-6 shrink-0 cursor-pointer items-center gap-1 rounded-full bg-accent/70 px-2 text-[10.5px] font-medium text-muted-foreground transition-colors duration-200 hover:bg-accent hover:text-foreground";
