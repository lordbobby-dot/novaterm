...
function distroCommand(key: DistroKey, version: string): string {
  switch (key) {
    case "arch":
      return "yay -S novaterm-bin";
    case "debian":
      return `sudo apt install ./NovaTerm_${version}_amd64.deb`;
    case "fedora":
      return `sudo dnf install ./NovaTerm-${version}-1.x86_64.rpm`;
  }
}
            ...
            {ready
              ...
              : downloading
                ...
                : manual
                  ...
                  : `NovaTerm v${update?.version} is available`}
          </DialogTitle>
          <DialogDescription>
            {ready
              ? "Restart NovaTerm to finish installing."
              : downloading
                ? progress !== null
