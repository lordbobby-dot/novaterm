...
const SIDEBAR_WIDTH_STORAGE_KEY = "novaterm.sidebar.width";
const SIDEBAR_VIEW_STORAGE_KEY = "novaterm.sidebar.view";
const SIDEBAR_COLLAPSED_STORAGE_KEY = "novaterm.sidebar.collapsed";
